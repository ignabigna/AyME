...
b_lmax = 0.13; % variacion positiva
b_lmin = 0.1-0.03; % variacion negativa
b_l = 0.1; % coeficiente de friccion viscosa de articulacion [N.m/rad.s]
%==============================================
...
m_l = 0.75; % modificable "Nominal promedio  de max y min"
%=========================================
...
%======calculo de J_eq y b_eq MAXIMOS============
J_eq_max = J_m + (((m * l_cm^2 + J_cm) + m_lmax * l_l^2) / r^2);
b_eq_max = b_m + ((b_lmax) / r^2);
%======calculo de J_eq y b_eq MINIMOS============
J_eq_min = J_m + (((m * l_cm^2 + J_cm) + m_lmin * l_l^2) / r^2);
b_eq_min = b_m + ((b_lmin) / r^2);